...
public class GameState extends State {
    ...
    public void refresh() {
        ...
        uiManager.addObjects(new UIImageButton(((handler.getWidth() / 2)) - ((handler.getWidth() / 13)) , (handler.getHeight() /2) - handler.getHeight()/20, handler.getWidth()/6, handler.getHeight()/6, Images.pacmanLogo, new ClickListlener() {
            @Override
            public void onClick() {
                handler.getMouseManager().setUimanager(null);
